#!/usr/bin/env python3
"""
Export ALL embedding test data to markdown for AI analysis

Usage:
    python3 scripts/export_full_data.py
"""
...
def export_full_data():
    ...
    print("📦 Exporting full test data...\n")
    ...
    md += "**Example:** `g25f_oai3l_gpt4o_mwM_#1`\n"
